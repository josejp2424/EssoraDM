	...
	: currentSession(-1)
{
	...
	options.insert(option("screenshot_cmd","import -window root /essoradm.png"));
	...
	options.insert(option("lockfile","/var/run/essoradm.lock"));
	options.insert(option("logfile","/var/log/essoradm.log"));
	options.insert(option("authfile","/var/run/essoradm.auth"));
